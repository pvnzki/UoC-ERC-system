    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-md flex items-center justify-center z-50">
      ...
      >
        ...
        <div className={`mb-4 p-3 rounded-lg ${
          isDarkMode ? "bg-blue-900/20 border border-blue-700/30" : "bg-blue-50/80 border border-blue-200/50"
        }`}>
          ...
          <div className={`text-sm space-y-1 ${
            ...
            <p><strong>Name:</strong> {formData.committeeName}</p>
            <p><strong>Description:</strong> {formData.description || "No description"}</p>
            <p><strong>Max Members:</strong> {formData.maxMembers || "Unlimited"}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter maximum number of members (optional)"
            />
          </div>
